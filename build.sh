...
i686-w64-mingw32-gcc -Wl,--kill-at -Wl,--enable-stdcall-fixup -Wformat -fPIC -static -shared -Iminhook_prebuilt/include main.c -Lminhook_prebuilt/bin/ -Wl,-Bdynamic -lMinHook.x86 -lws2_32 -o x86/wintab32.dll
